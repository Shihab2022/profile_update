...
const User = () => {
    ...
    return (
        ...
        <div className='grid md:grid-cols-4 gap-5'>
            {
            user?.map(d=>
            <div key={d.id} className='bg-gradient-to-r from-cyan-300 to-cyan-700 h-[400px] rounded-t-xl p-5'>
            ...
            <button   className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-7 py-2 text-white rounded-md'>Update</button>
